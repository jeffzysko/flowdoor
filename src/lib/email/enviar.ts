 ...
 * domínio e as chaves de DKIM não mudam. O que sai daqui chega assinado igual
 * ao que sai de lá.
 *
 ...
 * função devolve um resultado em vez de lançar erro.
 */
...
export async function enviarEmail(opcoes: {
  ...
  try {
    const r = await fetch(ENDPOINT, {
      ...
      // de quem convidou não pode ficar esperando.
