create type field_event_kind as enum ('aplicacao', 'vistoria', 'retirada', 'troca', 'manutencao', 'registro');
create type field_event_status as enum ('pendente', 'em_andamento', 'concluido', 'cancelado', 'falhou');
...
create table proofs (
  ...
  public_token text not null default encode(gen_random_bytes(24), 'base64'),
